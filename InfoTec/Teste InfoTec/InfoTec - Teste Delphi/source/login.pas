...
var
  frmLogin: TfrmLogin;
  gi_idUsuario : Integer;

implementation

{$R *.dfm}

uses Main, uDados, uCadProdutos, CadUsuario;

procedure TfrmLogin.btnConfirmaClick(Sender: TObject);
begin
  //if txtLogin.Text = 'A' and txtSenha.Text = 'A' then
  if (txtLogin.Text = 'A') and (txtSenha.Text = 'A') then
  begin
    frmMain.ShowModal;
    frmLogin.Hide;
  ...
  begin
     //Não encontrou o usuário cadastrado no banco, ou os dados informados estão errados
